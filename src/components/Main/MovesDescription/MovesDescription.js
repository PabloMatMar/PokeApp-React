...
const MovesDescription = () => {
  ...
  return <section className='movesDescription'>
    {!(data // 👈 comprobando que data no esta vacio
    && Object.keys(data).length === 0
    && Object.getPrototypeOf(data) === Object.prototype) ? <>
      ...
      <table>
        ...
        <tbody>
          <tr>
            ...
            {data.accuracy !== null ? <td colSpan="3">{data.accuracy}%</td> : <td colSpan="3">100%</td>}
          </tr>
          <tr>
          ...
          <tr>
            <td colSpan="1">Special Effect:</td>
            <td colSpan="3"><SpecialEffect data={data.contest_effect} /></td>
          </tr>
          <tr>
